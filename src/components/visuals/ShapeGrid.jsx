...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      ...
      // Cell indices are only meaningful for the canvas size they were
      // recorded at — a resize (layout shift, font swap, window resize)
      // can otherwise leave a stale hover/trail cell rendering at the
      // wrong spot on the newly-sized grid.
  ...
  return <canvas ref={canvasRef} aria-hidden="true" className={`shapegrid-canvas ${className}`}></canvas>;
};
